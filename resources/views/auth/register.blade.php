...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: 'Inter', system-ui, sans-serif; }
        ...
        .left-section { padding: 48px; background: #fff; color: var(--text-color); display: flex; flex-direction: column; gap: 18px; align-items: flex-start; justify-content: center; text-align: left; }
        .left-section h1 { margin: 0; font-size: 28px; font-weight: 700; }
        .left-section p { margin: 0; color: var(--muted); max-width: 400px; }
        .illustration-placeholder { display: block; margin-bottom: 20px; color: var(--muted); font-style: italic; } /* Placeholder ilustrasi */
        .link-primary { color: var(--blue); text-decoration: none; font-weight: 600; }
        .link-primary:hover { text-decoration: underline; }

        .right-section { padding: 48px; background: var(--blue); color: #fff; display: flex; flex-direction: column; gap: 18px; align-items: center; justify-content: center; }
        .form-wrapper { width: 100%; max-width: 420px; }
        h2 { text-align: left; margin-bottom: 24px; color: #fff; font-size: 24px; font-weight: 700; }
        .form-group { margin-bottom: 16px; }
        .sr-only { position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0, 0, 0, 0); white-space: nowrap; border-width: 0; }
        .form-input { width: 100%; padding: 12px 16px; border-radius: 10px; border: 1px solid transparent; background: var(--input-bg); color: var(--text-color); font-size: 15px; }
        ...
        .btn { display: inline-block; width: 100%; padding: 12px; border-radius: 10px; border: 0; color: var(--text-color); font-weight: 700; cursor: pointer; transition: background-color 0.2s ease, opacity 0.2s ease; text-align: center; }
        .btn-primary { background: #ffcc00; /* Tombol kuning */ }
        .btn-primary:hover { opacity: 0.9; }
        .btn-secondary { background: transparent; color: #fff; border: 1px solid rgba(255, 255, 255, 0.5); margin-top: 10px; }
        .btn-secondary:hover { background: rgba(255, 255, 255, 0.1); }
        .muted-text { font-size: 13px; color: rgba(255, 255, 255, 0.8); text-align: center; margin-top: 24px; }
        ...
        .field-error { font-size: 13px; color: #fef2f2; margin-top: 4px; }
        .form-check { display: flex; align-items: center; gap: 8px; margin-bottom: 20px; color: rgba(255, 255, 255, 0.9); font-size: 14px; }
        .form-check input[type="checkbox"] { width: 16px; height: 16px; accent-color: #ffcc00; }
        .password-hint { font-size: 12px; color: rgba(255, 255, 255, 0.7); margin-top: -12px; margin-bottom: 16px; display: block; }
...
<body>
    <div class="container-panel" role="main">
        <div class="left-section">
            <span class="illustration-placeholder"></span> <h1>Welcome!</h1>
            ...
            <div class="form-wrapper">
                ...
                <form method="POST" action="{{ route('register.process') }}">
                    ...
                    <div class="form-group">
                        ...
                        <span class="password-hint">Minimal 8 karakter.</span> {{-- Hint diperbarui --}}
                    ...
                    <button class="btn btn-secondary" type="button" onclick="window.location.href='{{ route('login.form') }}'">Sign In</button>
                </form>
            </div>
        </div>
    </div>
